...
<ResponsiveWrapper test>
        ...
        <s.Container
          ...
          jc={"center"}
          ai={"center"}
          image={CONFIG.SHOW_BACKGROUND ? "/config/images/squaregreen.png" : null}
          style={{
            padding: 30,
            paddingBottom: 10,
            paddingTop: 10,
...
<div class="card" style={{marginLeft:"100px", marginRight:"-30px"}}>
...
<ResponsiveWrapper test>
        ...
        <s.Container
          ...
          jc={"center"}
          ai={"center"}
          image={CONFIG.SHOW_BACKGROUND ? "/config/images/menudef.png" : null}
          style={{
            padding: 10,
            paddingLeft: 25,
            paddingRight: 25,
...
<div class="card">
  ...
  <s.SpacerXSmall />
          ...
          >
             A collection made and focused for the Pulse community. The Pulse Stars are here to shine on the PulseChain Network. 6,666 Stars forged in the core of a Supernova...
          </s.TextDescription>
          <s.SpacerMedium />
          <StyledButton
                    onClick={(e) => {
  ...
  <div class="card" style={{marginLeft:"-140px", color: "#fff0",
...
<ResponsiveWrapper test>
        ...
        <s.Container
          ...
          jc={"center"}
          ai={"center"}
          image={CONFIG.SHOW_BACKGROUND ? "/config/images/menumt.png" : null}
          style={{
            padding: 10,
            paddingLeft: 25,
            paddingRight: 25,
...
<div class="card">
        ...
        <div class="card" onClick={handleTwitter} target="_blank" rel="noopener noreferrer">
        <s.Container
          flex={1}
          jc={"center"}
          ai={"center"}
  ...
  <s.SpacerXSmall />
          ...
          >
            The MUTANT APE ANTIDAN CLUB is a collection of 999 Mutant Apes landing on PulseChain to give hand to the Ape community. The funds from this project...
            </s.TextDescription>
          <s.SpacerMedium />
          <StyledButton
                    onClick={(e) => {
  ...
  <div class="card" style={{marginLeft:"-155px", marginRight:"-130px"} }>
